    ...
    try:
        if len(lmlist) != 0:
            ...
            if fingers[1] and fingers[2] and fingers.count(1) == 2:
                ...
                # additional spiderman hand
            elif fingers[0] and fingers[1] and fingers[4] and fingers.count(1) == 3:
                cv2.putText(frame, "Spiderman", (50,270), cv2.FONT_HERSHEY_PLAIN, 3, (0,255,0), 3)
    except:
        pass
    current_time = time.time()
    fps = 1 / (current_time - previous_time)
    previous_time = current_time
    cv2.putText(frame, "frame rate: "+str(int(fps)),
    (350,70), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255), 2)
